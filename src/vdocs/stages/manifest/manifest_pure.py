...
USAGE = (
    ...
    "~89% of live sections carry indexed text; the remaining 10.5% are bare headings whose "
    "substance sits in their subsections. Prose can still live in the gold body.md and its "
    "extracted tables. Before saying the corpus does not cover something, read the document's "
