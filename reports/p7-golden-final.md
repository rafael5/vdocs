...
- **Labeled queries:** 18 of 25  ·  ⚠️ **6 UNSCOREABLE** (every judged section is outside corpus scope — excluded from the means; re-label or retire them)
- **mean nDCG@10:** 0.5305
- **mean MRR:** 0.5648
...
| kids-delphi-components-install | kids-install | — | — | — | 0.0 | 10 |
| hwsc-rest-from-vista-m | hwsc-rest | — | — | — | 0.1 | 10 |
| hwsc-install-privileges | hwsc-rest | — | — | — | 0.1 | 10 |
| kaajee-install-procedure | kaajee-auth | — | — | — | 0.2 | 10 |
...
| lexicon-lookup | lexicon | — | — | — | 0.0 | 10 |
| hl7-security-keys | hl7-security | 0.9173 | 1.0 | 0.5 | 0.1 | 10 |
| hwsc-web-service-manager | hwsc-manage | — | — | — | 0.3 | 9 |
