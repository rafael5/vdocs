...
- **mean nDCG@10:** 0.277
- **mean MRR:** 0.3326
- **mean recall@10:** 0.3472
- **mean redundancy@10:** 0.056 (all queries)
...
| fileman-import-host-file | api-leadin | 0.0356 | 0.1 | 0.3333 | 0.0 | 10 |
| fileman-input-transform-definition | api-leadin | 0.0 | 0.0 | 0.0 | 0.0 | 10 |
| fileman-blddialog-icr-number | api-leadin | 0.0413 | 0.125 | 0.5 | 0.0 | 10 |
| quasar-package-wide-variables | short-reference | 0.0 | 0.0 | 0.0 | 0.1 | 10 |
| hl7-table-0136-values | short-reference | 0.6236 | 1.0 | 0.6667 | 0.0 | 10 |
