...
> retrieval quality **+44% mean nDCG@10** over the golden set. Effort:
> `docs/historical/pipeline-audit-remediation-implementation-plan.md` + its tracker.
>
> ⚠️ **Golden-retrieval figures predating 2026-08-02 were measured against the wrong corpus** — a
> stale 451-document `~/data/vdocs-dev` lake (this includes `nDCG@10 = 0.469`, quoted in the
> effort's tracker rather than here). The true production pre-fix baseline is **0.2770**. See
> `reports/README.md`.
