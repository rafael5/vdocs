...
⛔ **Do not start before `vdocs-quality-crawl-integrity` is ticked `CI ✓` and `vdocs-quality-report-card` `RC ✓`** (in that order, revised 2026-08-03), even though this effort does not consume the answer key directly.
